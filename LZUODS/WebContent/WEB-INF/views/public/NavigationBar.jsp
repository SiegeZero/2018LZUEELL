...
<nav class="navbar navbar-default top-navbar" role="navigation">
	...
	<ul class="nav navbar-top-links navbar-right">
		<li><a class="waves-effect waves-dark" href="HMHome"><i class="fa fa-bell fa-fw"></i> <strong>首页</strong></a></li>
		<li><a class="waves-effect waves-dark" href="HMMang"><i class="fa fa-user fa-fw"></i> <strong>人员管理</strong></a></li>
